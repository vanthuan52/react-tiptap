...
export const StatusBar = () => {
  ...
  return (
    <div className="rte-status-bar">
      ...
      <div className="rte-status-bar__counter">
        <span className="rte-status-bar__word-count">Words: {counter.words}</span>
        <span className="rte-status-bar__character">Characters: {counter.characters}</span>
      </div>
    </div>
  );
};
