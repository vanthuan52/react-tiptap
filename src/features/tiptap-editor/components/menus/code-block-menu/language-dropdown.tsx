...
export const LanguageDropdown = ({
  ...
  return (
    ...
    >
      <SearchInput
        className="rte-code-dropdown__search"
      ...
      {/* <Input
        ...
        onChange={handleSearchChange}
      /> */}
      <div className="rte-code-dropdown__list" style={{ overflowY: "auto" }}>
          ...
          filteredOptions.map((item) => (
            <PopoverClose asChild key={item.value}>
              <div
                role="button"
                tabIndex={0}
                className="rte-code-dropdown__item"
              ...
              >
                ...
                {item.value === value && (
                  <Icon
                    name="Check"
                    className="rte-code-dropdown__indicator"
                    size={14}
                    strokeWidth={2.5}
                  />
                )}
